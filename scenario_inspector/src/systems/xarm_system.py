...
class XarmSystem(BaseSystem):
    ...
    def __init__(self, name: str, config: Dict[str, Any]):
        ...
        self.programs_path = config.get('programs_path', './xarm_programs')
    ...
    def _move_to_position(self, step_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if not self.connected or not self.enabled:
                return {
                    "success": False,
                    "error": "Robot not connected or not enabled",
                    "timestamp": self.get_timestamp()
                }
    ...
    def _load_program(self, step_config: Dict[str, Any]) -> Dict[str, Any]:
        """Load a program on the xArm robot"""
        try:
            if not self.connected:
                return {
                    "success": False,
            ...
            self.logger.info(f"Loading xArm program: {program_path}")
            
            result = self.arm.load_program(program_path)
            ...
            if result == 0:
                ...
                return {
                    "success": False,
                    "error": f"Load program failed with error code: {result}",
                    "timestamp": self.get_timestamp()
                }
    ...
    def _start_program(self, step_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Starting xArm program: {self.current_program}")
            
            result = self.arm.run_program()
            
            if result == 0:
                return {
                    "success": True,
                    "message": f"Program started: {self.current_program}",
                    "details": {
                ...
                return {
                    "success": False,
                    "error": f"Start program failed with error code: {result}",
                    "timestamp": self.get_timestamp()
                }
    ...
    def _stop_program(self, step_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if result == 0:
                ...
                return {
                    "success": False,
                    "error": f"Stop program failed with error code: {result}",
                    "timestamp": self.get_timestamp()
                }
